...
<table style="width: 90vw; text-align: center;">
  <tr>
    <td style="padding: 5vw;"> <!-- Adjusted padding -->
      <img src="/img/logo2-removebg-preview.png" alt="Brain" style="height: 30vw; width: 30vw;">
    </td>
    <td style="padding: 5vw;"> <!-- Adjusted padding -->
      <img src="/img/logo4-removebg-preview.png" alt="Muscles" style="height: 30vw; width: 30vw;">
    </td>
    <td style="padding: 5vw;"> <!-- Adjusted padding -->
      <img src="/img/logo3-removebg-preview.png" alt="Heart" style="height: 30vw; width: 30vw;">
    </td>
  </tr>
</table>
...
<table style="width: 90vw; text-align: center;">
  <tr>
    <td style="padding: 10vw;"> <!-- Adjusted padding -->
      <img src="/img/brain-removebg-preview.png" alt="Brain" style="height: 30vw; width: 30vw;">
    </td>
    <td style="padding: 5vw;"> <!-- Adjusted padding -->
      <img src="/img/Muscles-removebg-preview.png" alt="Muscles" style="height: 30vw; width: 30vw;">
    </td>
    <td style="padding: 5vw;"> <!-- Adjusted padding -->
      <img src="/img/heart-removebg-preview.png" alt="Heart" style="height: 30vw; width: 30vw;">
    </td>
  </tr>
</table>
...
<table style="width: 90vw; text-align: center;">
  <tr>
    <td style="padding: 10vw;"> <!-- Adjusted padding -->
      <img src="/img/ac_motor-removebg-preview.png" alt="AC Motor" style="height: 30vw; width: 30vw;">
    </td>
    <td style="padding: 5vw;"> <!-- Adjusted padding -->
      <img src="/img/tree-removebg-preview.png" alt="Tree" style="height: 30vw; width: 16vw;">
    </td>
    <td style="padding: 5vw;"> <!-- Adjusted padding -->
      <img src="/img/solonoid-removebg-preview.png" alt="Solenoid" style="height: 30vw; width: 30vw;">
    </td>
  </tr>
</table>
...
<table style="width: 90vw; text-align: center;">
  <tr>
    <td style="padding: 10vw;"> <!-- Adjusted padding -->
      <img src="/img/Oxygen-removebg-preview.png" alt="Oxygen" style="height: 30vw; width: 30vw;">
    </td>
    <td style="padding: 5vw;"> <!-- Adjusted padding -->
      <img src="/img/cathode-removebg-preview.png" alt="Cathode" style="height: 30vw; width: 30vw;">
    </td>
    <td style="padding: 5vw;"> <!-- Adjusted padding -->
      <img src="/img/molecule-removebg-preview.png" alt="Molecule" style="height: 30vw; width: 30vw;">
    </td>
  </tr>
</table>
...
<table style="width: 90vw; text-align: center;">
  <tr>
    <td style="padding: 10vw;"> <!-- Adjusted padding -->
      <img src="/img/tajmahal-removebg-preview.png" alt="Taj Mahal" style="height: 30vw; width: 30vw;">
    </td>
    <td style="padding: 5vw;"> <!-- Adjusted padding -->
      <img src="/img/Christ_the_Redeemer__Brazil-removebg-preview.png" alt="Christ the Redeemer" style="height: 30vw; width: 30vw;">
    </td>
    <td style="padding: 5vw;"> <!-- Adjusted padding -->
      <img src="/img/The_Colosseum__Rome__Italy-removebg-preview.png" alt="The Colosseum" style="height: 30vw; width: 30vw;">
    </td>
  </tr>
</table>
